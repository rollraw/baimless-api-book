...
| iRageAutoZeusDelay                     |
| bRageAutoStopEarly                     |
| flRageAutoStopEarlyPredictionTime      |
| iRageHeadScale                         |
| iRageBodyScale                         |
| keyRageDoubleTap                       |
| bRageDoubleTapWaitRecharge             |
| flRageDoubleTapRechargeDelay           |
| bRageDoubleTapAdaptiveDamage           |
| iRageDoubleTapHitChance                |
| keyRageHideShots                       |
...
| iRageLogicEnemyForceHealthLess         |
| bRageFakeLag                           |
| iRageFakeLagType                       |
| iRageFakeLagTicks                      |
| iRageFakeLagJitter                     |
